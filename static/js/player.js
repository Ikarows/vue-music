...
$(function () {
	...
	// 双击列表tr播放
	$(document).delegate('#infoList_playlist tr','dblclick', function(){
		var _this=this;
	...
	// 双击搜索列表tr播放
	$(document).delegate('#infoList_search tr','dblclick', function(){
	...
	$(media).on("timeupdate",function () {
		if (!isDrag) {
			...
			var i =  !isNaN(objTimeDuration.I) ? objTimeDuration.I : '00';
			var s =  !isNaN(objTimeDuration.S) ? objTimeDuration.S : '00';
			//更新当前播放时长
			$duration.html( i + ":" + s );
			// 更新进度条
